...
5. No individual SL/TP
6. When 10 are open and **combined net P&L after fees ≥ +2% of batch capital** → close all
7. Reset batch → open next 10 → repeat

Knobs: `MIN1_MAX_OPEN`, `MIN1_BATCH_PROFIT_PCT`, `MIN1_SIZE_FRAC`, `MIN1_LOOKBACK`, `MIN1_DOJI_BODY_RATIO`

## Fire Engine (non-1M)
Patterns + shadow + structure + EMA/MACD/ADX/RSI confluence → SL/TP 1:2.
