...
_ENGINE_FORMULA_SEEDS: list[tuple[str, str, str, float | None, str | None, str]] = [
    ...
    ("of", "THR_SCORE", "number", 65.0, None, "Base OF floor"),
    ("of", "THR_SCORE_5M", "number", 65.0, None, "5m OF floor"),
    ("of", "THR_SCORE_1M", "number", 65.0, None, "1m OF floor"),
    ("of", "THR_SCORE_CLASSIC_PATTERN", "number", 65.0, None, "Doji/classic OF floor"),
    ("of", "THR_SCORE_ENGULFING", "number", 65.0, None, "Engulfing OF floor"),
    ("of", "THR_SCORE_INSIDE_BAR", "number", 65.0, None, "Inside-bar OF floor"),
    ("of", "THR_SCORE_IMBALANCE_1M", "number", 65.0, None, "Imbalance scalp floor"),
    ("of", "THR_SCORE_TRAP", "number", 80.0, None, "Trap floor HTF"),
    ("of", "THR_SCORE_TRAP_5M", "number", 70.0, None, "Trap floor 5m"),
    ("of", "THR_SCORE_TRAP_1M", "number", 70.0, None, "Trap floor 1m"),
