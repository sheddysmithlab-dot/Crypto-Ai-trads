...
export const EXIT_POLICY_SHORT =
  'profit +0.65% peak-trail · loss soft −0.60%…−0.80% (all TFs)';

export const EXIT_POLICY_CHART_OVERLAY =
  'Path exit · profit +0.65% trail / loss −0.60%…−0.80%';

export const EXIT_POLICY_SYSTEM_LOG =
  'Path exit (all TFs incl. 1m): profit arm +0.65% peak-trail −0.1%; soft −0.60% hard −0.80% unlock −0.2%';

export const EXIT_POLICY_MODAL =
  'Path exit — all TFs (incl. 1m): profit arm +0.65% with peak trail −0.1%; soft lock −0.60%, hard −0.80%, unlock −0.2%.';
