/**
 * Shown when user presses AI ENGINE STOP with open trades.
    ...
    <div className="fixed inset-0 bg-black/80 z-[115] flex items-center justify-center backdrop-blur-sm p-4">
      <div className="modal-enter bg-[#0B0E11] p-6 sm:p-8 rounded-2xl shadow-2xl max-w-md w-full border-2 border-amber-500 text-center">
        ...
        <p className="text-xs text-gray-500 mb-6">
          Both choices turn the button back to green START. Next START begins a fresh session from 0
          without touching any held trades.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[10px] text-gray-500 -mt-1 px-1">
            Stop new fires. Held trades keep path SL/TP (0.5%/0.7%) and update portfolio until they close.
          </p>
