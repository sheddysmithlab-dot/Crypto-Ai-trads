const SECTIONS = [
  {
    ...
    items: [
      ...
      'Every TF: pattern detect → candle-1 impulse lock (≥2×trail) → trail% pullback post-only maker. Miss / opposite color / move already ≥ profit = skip (no taker chase). Exit stays market/taker.',
      ...
      '1m/5m: AI Engine soft-restarts every 1 hour (fresh momentum scan + momentum-lock pullback pipeline; open trades kept).',
    ],
  },
  {
