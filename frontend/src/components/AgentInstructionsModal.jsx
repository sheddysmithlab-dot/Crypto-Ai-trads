...
export default function AgentInstructionsModal({ open, onClose, onStart }) {
  ...
  const trades = Math.max(1, Math.floor(stopLoss * 1.5 + 0.5));
  const isRed = risk > 50;
      ...
      <div className={`bg-[#0B0E11] border-2 rounded-2xl max-w-md w-full ${borderGlow}`}>
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between bg-[#161A1E] border border-gray-700 rounded-lg px-4 py-3">
              <span className="text-xs font-semibold text-gray-300">Daily profit target <span className="text-gray-500">(optional)</span></span>
              <div className="flex items-center gap-1">
                <input
                  type="number"
                  min="0"
          ...
          <p className="text-center text-xs text-gray-400">
            ...
            {' '}(= risk x 1.5). Emergency STOP closes everything.
          </p>
